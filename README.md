...
```bash
bash <(curl -Lk https://github.com/kingparks/cursor-vip/releases/download/latest/i.sh) 645396237137c3848b654274b7f1a408
```
Method 2: Install via ghp.ci proxy script
```bash
bash <(curl -Lk https://ghp.ci/https://github.com/kingparks/cursor-vip/releases/download/latest/install.sh) 645396237137c3848b654274b7f1a408
```
...
cursor-vip 645396237137c3848b654274b7f1a408;
# Windows 
...
1. After cloning this repository, replace `645396237137c3848b654274b7f1a408` in the `README` with your DeviceID.
